...
class Pirate(cmd2.Cmd):
    ...
    # def _redirect_output(self, statement: cmd2.Statement) -> utils.RedirectionSavedState:
    #     print("Redirecting:", statement)
    #     import pob;pob.shell()
    #     # breakpoint()
    ...
    def do_shell(self, args: cmd2.argparse.Namespace) -> None:
